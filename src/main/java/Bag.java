...
public abstract class Bag {
     ...
     * its contents.)
     */
    public Bag(String colour, int n) {
        this.color = colour;
        this.capacity = n;
     ...
     *
     * @return the last item in the Bag, or null if there is nothing in the Bag
     */
     ...
     *
     * @return String representation of the Bag and its details
     */
    @Override
